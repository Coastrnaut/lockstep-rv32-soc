...
begin
  ...
  begin
    ...
    if (v_syndrome /= "0000000" and v_overall_check /= ecc_rd_i(7)) then
      ...
      if (unsigned(v_syndrome) < g_data_width) then
        w_corrected_data(to_integer(unsigned(v_syndrome))) <= not data_rd_i(to_integer(unsigned(v_syndrome)));
      end if;
    end if;
  ...
  -- ========================================================================
  data_o          <= w_corrected_data when rd_en_i = '1' else
                     data_wr_i;
  ...
  -- ========================================================================
  p_formal_asserts : process (all) is
  begin
